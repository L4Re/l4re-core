 ...
 *
 * For an explanation of the default task capabilities see \ref
 * l4_default_caps_t.
 *
...
typedef struct l4re_env_t
{
  ...
  l4_cap_idx_t first_free_cap; ///< First object capability index available
                               ///< to the application
                               ///< (***not*** shifted by #L4_CAP_SHIFT)
  l4_umword_t  first_free_reply_cap; ///< First reply capability index available
                                     ///< to the application
                                     ///< (***not*** shifted by #L4_CAP_SHIFT)
