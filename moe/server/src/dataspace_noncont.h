...
public:
  ...
  l4_ret_t pre_allocate(L4Re::Dataspace::Offset offset,
                        L4Re::Dataspace::Size size, unsigned rights) override;
...
public:
  l4_ret_t clear(L4Re::Dataspace::Offset offs,
                 L4Re::Dataspace::Size size) const noexcept override;
